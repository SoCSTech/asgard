...
import TimetableEventsTableList from "../components/timetableEventsTableList";
...
import ColourSelector from "@/components/theme/colourPicker";
import FavouriteButton from "@/components/theme/favouriteButton";
...
export function TimetablePage(props: Props) {
  ...
  return (
    <>
      {timetable.isDeleted && (
        <div className="flex w-full flex-col p-2 pt-0 text-xl tablet:p-10">
          <div className="rounded-xl bg-destructive px-10 py-5 text-center text-white">
            <p>
      ...
      <div className="flex w-full flex-col items-center p-2 pt-0 text-center text-xl tablet:p-10">
        <div className="flex w-full flex-col items-center justify-between laptop:flex-row">
          ...
          <div className="mt-5 flex flex-col justify-evenly gap-2 rounded-xl bg-black p-5 tablet:flex-row laptop:mt-0">
        ...
        <Tabs defaultValue="list" className="mt-5 w-full">
          <TabsList className="grid grid-cols-3 tablet:w-1/3">
            <TabsTrigger value="calendar">Calendar</TabsTrigger>
            <TabsTrigger value="list">Events List</TabsTrigger>
            <TabsTrigger value="carousel">Carousel</TabsTrigger>
          </TabsList>
          <TabsContent value="list">
            <div className="relative mt-5 w-full items-center overflow-x-auto rounded-xl tablet:shadow-md">
          ...
          <TabsContent value="carousel">
            ...
            <div className="flex w-full flex-col flex-wrap justify-center tablet:flex-row">
              {carousel.items &&
